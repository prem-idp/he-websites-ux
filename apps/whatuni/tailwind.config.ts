  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        gradient18:
          "linear-gradient(0deg, rgba(15, 23, 42, 0.8) 0%, rgba(0, 0, 0, 0) 41.67%)",
      },
      boxShadow: {
        "custom-1":
  ...
  plugins: [
    function ({ addUtilities }: any) {
      addUtilities({
        ".custom-filter-icon": {
          filter:
            "brightness(0) saturate(100%) invert(16%) sepia(13%) saturate(7%) hue-rotate(322deg) brightness(93%) contrast(87%);",
        },
      });
    },
  ],
