    ...
    Cognito: {
      ...
      loginWith: {
        ...
        oauth: {
          ...
          redirectSignIn: ["http://localhost:3000/authverification","https://mdev.dev.aws.whatuni.com","https://mdev.dev.aws.whatuni.com/money/budgeting/ug-student-budget-calculator"],
