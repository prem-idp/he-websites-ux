...
const ClearingUniversity = () => {
  ...
  const universities = [
    "University of Bangor (Active state)",
    "Middlesex University (Hover state)",
  ...
  return (
    <section className="bg-grey-50 md:py-[64px]">
      <div className="w-full md:w-[598px] mx-auto md:border md:border-grey-200 md:rounded-[8px] bg-white">
        <div className="flex flex-col p-[16px] gap-[16px] md:gap-[24px] md:p-[32px]">
          ...
          <div className="flex flex-col gap-[24px] p-[16px] border border-grey-200 rounded-[8px] bg-grey-50">
            <div className="flex flex-col gap-[8px]">
              ...
              <div className="relative">
                {isUniversityOpen && (
                  ...
                  >
                    <div className="flex flex-col gap-[12px] h-[275px] overflow-y-auto custom-scrollbar-2">
                      <div
                        onClick={universityClicked}
            ...
            <div className="flex flex-col gap-[4px]">
              ...
              {universities.map((item, index) => (
                <div
                  className="form_check active relative bg-white border border-grey-200 rounded-[4px] p-[12px] hover:border-primary-400"
                  key={index}
                >
                  <div className="flex items-start gap-[8px]">
                    <div className="checkbox_card">
