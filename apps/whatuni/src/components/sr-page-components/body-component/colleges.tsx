            ...
            <div className="border border-gray-300 p-[10px] lg:mb-[20px] lg:p-[24px]">
              <div className="flex items-center justify-between">
                <div className="flex flex-col">
                  <a className="text-primary-500 font-semibold text-para-lg hover:underline">
                    {data.collegeName}
                  </a>
                  <a className="text-gray-400 font-semibold text-small hover:underline">
                  ...
                  <div className="flex items-center gap-[5px] pt-[14px]">
                    ...
                    <a href="#" className="text-primary-500 text-small">
                      1293 reviews
                    </a>
                  </div>
                </div>
