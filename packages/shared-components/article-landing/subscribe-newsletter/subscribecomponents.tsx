...
//import Ctabutton from "@packages/shared-components/common-utilities/cards/interaction-button/ctabutton";
      ...
      <div className="max-w-container mx-auto">
        <div className="subscribe-card-container flex flex-col md:items-center gap-[24px] px-[16px] md:px-[20px] py-[40px] md:py-[64px]">
          ...
          <Subscribebtn
            ...
            error={errorstate.checkboxError || errorstate.emailError || !email}
          />
        </div>
      </div>
    </div>
