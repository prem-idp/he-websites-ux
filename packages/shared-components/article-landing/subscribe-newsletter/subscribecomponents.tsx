      ...
      <div className="max-w-container mx-auto">
        <div className="subscribe-card-container flex flex-col md:items-center gap-[24px] px-[16px] md:px-[20px] py-[40px] md:py-[64px]">
          <div className="subscribe-header flex flex-col gap-[4px]">
            <div className="h2 font-bold md:text-center">
              Subscribe to our newsletter
            </div>
            <p className="font-normal small md:text-center mt-[8px]">
          ...
          <div className="subscribe-form-control w-full lg:w-[714px]">
            <input
              type="text"
              className="form-control w-full focus:outline-none p-[11px_10px_11px_24px] small text-grey-900 placeholder:text-grey-700  border border-grey-200 rounded-[30px] shadow-custom-1"
              aria-label="email address field"
              placeholder="Enter Enter your email address"
            />
          </div>
          <div className="col form_check flex items-start gap-[12px] relative">
