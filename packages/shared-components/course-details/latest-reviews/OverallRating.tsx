            ...
            <div className='card flex flex-col gap-[16px] w-full border border-grey-200 rounded-[8px] bg-white p-[16px] md:p-[24px]'>
                <div className='card-header flex flex-col gap-[8px]'>
                    <div className='flex flex-col md:flex-row items-start md:items-center justify-between gap-[8px]'>
                        ...
                        <div className='relative group flex items-center gap-[8px] para font-semibold text-primary-400 hover:text-primary-500 hover:underline cursor-pointer pb-[10px] mb-[-10px]'>{selectedValue?.questionTitle}
                            ...
                            <DropDown fetcheddata={fetcheddata} setSelectedval={setSelectedval}/>
                        </div>
                    </div>
                    <div className='rating-pod flex items-center gap-[8px]'>
                        <div className='rating-card flex items-center gap-[4px]'>
                            ...
                            <span className='font-normal small text-grey300'>{selectedValue?.overallRating}</span>
                        </div>
                    </div>
                </div>
                <div className='w-full flex flex-col gap-[8px]'>
                <PercentageBar name={"5 stars"} percentage={selectedValue?.fiveStar}/>
                <PercentageBar name={"4 stars"} percentage={selectedValue?.fourStar}/>

                <PercentageBar name={"3 stars"} percentage={selectedValue?.threeStar
}/>

                <PercentageBar name={"2 stars"} percentage={selectedValue?.twoStar}/>

                <PercentageBar name={"1 stars"} percentage={selectedValue?.oneStar}/>
