...
const Entryrequirementcard = ({ onOpenModal }:any) => {
  ...
  return (
    <>
     <Examtypemodalcomponents  isOpen={isOpen} onClose={togglemodal}/> 
...
<div className='card-header'>
  <div className='flex items-start md:items-center  gap-[16px] md:gap-[8px]'>
    ...
    <div onClick={()=>togglemodal()} className='flex items-center gap-[8px] para font-semibold text-primary-400 hover:text-primary-500 hover:underline cursor-pointer'>A level 
