            ...
            <div className="uniresults-inner flex flex-col md:flex-row md:gap-[24px]">
              ...
              <div className="uniresults-right flex flex-col flex-1 gap-[16px]">
                <div className="uni-info-card flex flex-col gap-[8px] md:gap-0">
                  <div className="clearing-tag xs-small font-bold text-positive-dark bg-green-200 uppercase w-fit rounded-[4px] p-[0_8px] mb-[8px]">
                    Clearing
                  </div>
                  ...
                  <div className="flex flex-col gap-[8px]">
                    ...
                    <div className="chance-acceptance flex gap-[8px]">
                      ...
                      <div className="flex gap-[4px]">
                        <div className="x-small font-semibold text-success-700 uppercase">
                          VERY LIKELY
                        </div>
                ...
                {/* Sticky Section */}
                <div
                  className={`uniresults-content-right flex items-end ${
                    isSticky
                      ? "fixed top-0 left-0 w-full bg-white shadow-custom-4 z-[4] transition-all p-[16px]"
                      : ""
                  }`}
                >
