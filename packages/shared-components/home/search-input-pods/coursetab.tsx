...
const CourseTab: React.FC<CourseTabProps> = ({
  ...
  const searchHandler = async () => {
    ...
    if (
      ...
      // }, locationUrl);
      GADataLayerFn("ga_events", "homepage_search", "subject_search", "NA", searchFormHandle?.subject?.parent_subject ? searchFormHandle?.subject?.parent_subject : searchFormHandle?.subject?.description, searchFormHandle?.subject?.parent_subject ? searchFormHandle?.subject?.description : "NA", "home_page", "NA","NA", "NA", "NA", "NA", "NA", "NA","NA", "NA", "in_year", await currentAuthenticatedUser(), searchFormHandle?.courseType?.qualDesc, "NA", "NA", "NA", "NA","NA",`${process.env.PROJECT}`,"NA","NA");
      router.push(
        `${searchFormHandle.subject.url}&location=${sanitizedRegionName}${ucasval ? `&score=0,${ucasval}` : ""}`
      );
      ...
      GADataLayerFn("ga_events", "homepage_search", "subject_search", "NA", searchFormHandle?.subject?.parent_subject ? searchFormHandle?.subject?.parent_subject : searchFormHandle?.subject?.description, searchFormHandle?.subject?.parent_subject ? searchFormHandle?.subject?.description : "NA", "home_page", "NA", "NA","NA", "NA", "NA", "NA", "NA", "NA","NA", "NA", "in_year", "0", searchFormHandle?.courseType?.qualDesc, "NA", "NA", "NA", "NA","NA",`${process.env.PROJECT}`,"NA","NA");
  ...
  const keywordSearch = async () => {
    ...
    if (baseUrl) {
      GADataLayerFn("ga_events", "homepage_search", "NA", sanitizedDescription, "NA", "NA", "home_page", "NA","NA", "NA", "NA", "NA", "NA", "NA","NA", "NA", "in_year", await currentAuthenticatedUser(), searchFormHandle?.courseType?.qualDesc, "NA", "NA", "NA", "NA","NA",`${process.env.PROJECT}`,"NA","NA");
