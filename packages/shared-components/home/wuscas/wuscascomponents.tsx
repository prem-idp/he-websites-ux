        ...
        <div className="wusca-container grid  xs:grid-rows-[3_minmax(0_auto)] md:grid-cols-[auto_minmax(352px,_1fr)] lg:grid-cols-[auto_minmax(598px,_1fr)] p-[16px] md:p-[20px] lg:p-[0] lg:pt-[80px] xs:gap-[24px] md:gap-[20px] lg:gap-[16px]">
          <div className="wusca-content flex flex-col justify-center col-start-1 row-start-2 md:row-start-1 lg:col-span-1 gap-[12px]">
            ...
            <p className="font-normal">
              Sed ac neque at magna sagittis rhoncus nec vel magna. Duis ac urna
              in sem sollicitudin efficitur eleifend ultrices velit.
            </p>
            <Link
              href="#"
              className="flex items-center gap-[6px] w-fit bg-primary-400 hover:bg-primary-500 text-white rounded-[20px] font-inter font-semibold text-small px-[20px] py-[10px] mt-[10px] mb-[16px]"
            >
              Learn more
              <svg
                width="16"
            ...
            <div className="app-store-container ">
              <ul className="flex gap-[16px] lg:gap-[24px]">
                <li>
          ...
          <div className="wusca-highlights grid grid-cols-3 items-baseline gap-[8px] row-start-3 row-end-4 col-start-1 col-end-2 md:row-start-2 md:row-end-3 md:col-start-1 md:col-end-3  lg:col-end-2 ">
            <div className="wusca-card flex items-center flex-col md:flex-row gap-[8px] px-[16px] py-[12px] rounded-[4px] border border-grey-300">
              <Image
                ...
                src="/assets/images/wusca/icon-building-outlined-grey.svg"
                width="32"
                height="32"
                alt="wusca chat icon"
              />
            ...
            <div className="wusca-card flex items-center flex-col md:flex-row gap-[8px] px-[16px] py-[12px] rounded-[4px] border border-grey-300">
              <Image
                className="w-[32px] h-[32px]'"
                src="/assets/images/wusca/icon-chat-outlined-grey.svg"
                width="32"
                height="32"
                alt="wusca chat icon"
              />
            ...
            <div className="wusca-card flex items-center flex-col md:flex-row gap-[8px] px-[16px] py-[12px] rounded-[4px] border border-grey-300">
              <Image
                className="w-[32px] h-[32px]"
                src="/assets/images/wusca/icon-shine-outlined-grey.svg"
                width="32"
                height="32"
                alt="wusca chat icon"
              />
          ...
          <div className="grid px-[20px] md:px-[16px] lg:px-[98px] md:py-[36px] row-start-1 row-end-2 lg:row-end-3 col-start-2 -col-end-1">
            <Image
              src="/assets/images/wusca/wusca-image.png"
              width={402}
              height={401}
              alt="wusca"
            />
