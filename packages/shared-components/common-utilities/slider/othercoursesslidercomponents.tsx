...
const Othercoursesslidercomponents = ({seasonWusca, data, openDays, featureOpd}:any) => {
  return (
    <>
        ...
        className="MultiSwiper">
          ...
          <SwiperSlide key={index} className="swiper-slide">
            <Othercoursesmaylikecard {...item} seasonWusca ='true' openDays={openDays} featureOpd={featureOpd} />
          </SwiperSlide>
        ))}          
          </Swiper>
        </div>
