...
const RedirectionButton = () => {
  return (
    <div className="flex justify-end gap-[8px]">
      <button className="group text-primary-400 w-[calc(50%_-_4px)] flex gap-[4px] items-center justify-start bg-white hover:bg-primary-400 hover:text-white border border-primary-400 rounded-[4px] p-[12px]">
      ...
      <button className="group text-primary-400 w-[calc(50%_-_4px)] flex gap-[4px] items-center justify-between bg-white hover:bg-primary-400 hover:text-white border border-primary-400 rounded-[4px] p-[12px]">
        <span className="flex flex-col text-left items-start">
