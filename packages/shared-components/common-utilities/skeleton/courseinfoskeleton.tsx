    ...
    <div className="courseinfo-container" id="skiplink1">
      <div className="max-w-container mx-auto">
        <div className="courseinfo-card-container flex flex-col lg:flex-row justify-between gap-[20px] pb-[40px]">
          <div className="h5 w-full md:w-[289px] px-[16px] md:px-[20px] xl:px-[0]">
                ...
                <div className="keystats-inner-row flex flex-col gap-[8px]">
                  ...
                  <div className="keystats-body grid grid-cols-1 md:grid-cols-3 gap-[16px]">
                    <div className="course-highlight__option flex items-start gap-[8px]">
                      ...
                      >
                        <path
                          d="M17.4444 9.6626H29M29 9.6626V21.2182M29 9.6626L17.4444 21.2182L11.6667 15.4404L3 24.107"
                          stroke="#d4d4d4"
                          strokeWidth="2.67"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                    ...
                    <div className="course-highlight__option flex items-start gap-[8px]">
                      ...
                      >
                        <path
                          d="M26.8575 21.7418C26.462 21.3462 25.9582 21.0766 25.4096 20.9669L22.0269 20.2903C20.1732 19.9196 18.2489 20.1773 16.5581 21.0227L16.1084 21.2475C14.4176 22.093 12.4933 22.3507 10.6396 21.9799L7.90268 21.4325C6.97365 21.2467 6.01323 21.5375 5.3433 22.2075M10.666 5.55029H22.0005L20.5837 6.9671V14.2942C20.5837 15.0457 20.8822 15.7665 21.4136 16.2979L28.4976 23.3819C30.2827 25.167 29.0184 28.2192 26.494 28.2192H6.17254C3.64806 28.2192 2.3838 25.167 4.16888 23.3819L11.2529 16.2979C11.7843 15.7665 12.0828 15.0457 12.0828 14.2942V6.9671L10.666 5.55029Z"
                          stroke="#d4d4d4"
                          strokeWidth="2.67"
                          strokeLinecap="round"
                          strokeLinejoin="round"
