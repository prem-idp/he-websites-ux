                        ...
                        {degreeSubjectData.map((item, index) => (
                            <div className='flex flex-col border border-grey-200 rounded-[8px] overflow-hidden md:flex-row' key={index}>
                                <div className='bg-blue-50 md:w-[232px] lg:w-[392px] shrink-0'>
                                    {/* <Image src={item.src} alt='Degree Subject' width={392} height={220} className='rounded-[8px_8px_0_0] w-full h-[193px] md:h-[130px] lg:h-[220px] md:rounded-[8px_0_0_0]' /> */}
                                </div>
                                <div className='flex flex-col gap-[16px] border-l border-grey-200 p-[16px] md:p-[24px]'>
                                    ...
                                    <ul className='grid grid-cols-1 lg:grid-cols-2 gap-[8px] w-full'>
                                        {item.subjectIncludes?.map((subitem, index) => (
                                            <li key={index}>
                                                <div className='w-full flex item-center justify-between gap-[4px] p-[12px_16px] border border-grey-200 hover:border-primary-400 rounded-[4px] bg-white hover:bg-primary-50 transition-all'>
