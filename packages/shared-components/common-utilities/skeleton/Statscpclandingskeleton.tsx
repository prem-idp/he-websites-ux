...
const Statscpclandingskeleton = () => {
  return (
    <>
    <div className="stats-container bg-white">
      <div className="max-w-container mx-auto">
        <div className="stats-card-container flex flex-col gap-[20px] px-[16px] md:px-[20px] xl:px-0 py-[40px]">
          <div className="skeleton skeleton-text-animated large_heading !mb-[4px] !w-[30%]"></div>
...
export default Statscpclandingskeleton