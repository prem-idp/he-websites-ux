          ...
          <div className="card-body">
            <div className="course-highlight__details grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-[16px_24px] md:gap-[24px_54px]">
              <div className="course-highlight__option flex flex-col items-start gap-[16px]">
                ...
                >
                  <path
                    d="M16.6401 4.01615C16.2314 3.84097 15.7686 3.84097 15.3599 4.01615L3.98488 8.89116C3.38739 9.14722 3 9.73472 3 10.3848C3 11.0348 3.38739 11.6223 3.98488 11.8784L8.28186 13.7199C8.43811 13.5429 8.63398 13.3987 8.85988 13.3019L15.3599 10.5162C16.1848 10.1626 17.1401 10.5448 17.4936 11.3697C17.8471 12.1946 17.465 13.1499 16.6401 13.5034L12.2084 15.4027L15.3599 16.7534C15.7686 16.9286 16.2314 16.9286 16.6401 16.7534L28.0151 11.8784C28.6126 11.6223 29 11.0348 29 10.3848C29 9.73472 28.6126 9.14722 28.0151 8.89116L16.6401 4.01615Z"
                    fill="#d4d4d4"
                  />
                  <path
                    d="M5.12882 15.9045L7.875 17.0814V23.7466C7.318 23.6202 6.74896 23.5257 6.1699 23.465C5.40652 23.385 4.80326 22.7817 4.72321 22.0183C4.65825 21.3987 4.625 20.7702 4.625 20.1345C4.625 18.6776 4.79954 17.2609 5.12882 15.9045Z"
                    fill="#d4d4d4"
                  />
                  <path
                    d="M14.8624 27.5651C13.769 26.4932 12.509 25.5922 11.125 24.9043V18.4742L14.0796 19.7405C15.3059 20.2661 16.6941 20.2661 17.9204 19.7405L26.8712 15.9045C27.2005 17.2609 27.375 18.6776 27.375 20.1345C27.375 20.7702 27.3417 21.3987 27.2768 22.0183C27.1967 22.7817 26.5935 23.385 25.8301 23.465C22.4617 23.8182 19.4326 25.3152 17.1376 27.5651C16.5057 28.1845 15.4943 28.1845 14.8624 27.5651Z"
                    fill="#d4d4d4"
                  />
                  <path
                    d="M9.5 29.8847C10.3975 29.8847 11.125 29.1572 11.125 28.2597V24.9043C10.1035 24.3966 9.0144 24.005 7.875 23.7466V28.2597C7.875 29.1572 8.60254 29.8847 9.5 29.8847Z"
                    fill="#d4d4d4"
                  />
                </svg>
              ...
              <div className="course-highlight__option flex flex-col items-start gap-[16px]">
                ...
                >
                  <path
                    fillRule="evenodd"
                    clip-rule="evenodd"
                    d="M8.3848 7.03909C12.5906 2.83332 19.4095 2.83332 23.6152 7.03909C27.821 11.2449 27.821 18.0638 23.6152 22.2695L16 29.8848L8.3848 22.2695C4.17903 18.0638 4.17903 11.2449 8.3848 7.03909ZM16 17.7313C17.6994 17.7313 19.077 16.3537 19.077 14.6543C19.077 12.9549 17.6994 11.5773 16 11.5773C14.3006 11.5773 12.923 12.9549 12.923 14.6543C12.923 16.3537 14.3006 17.7313 16 17.7313Z"
                    fill="#d4d4d4"
                  />
                </svg>
              ...
              <div className="course-highlight__option flex flex-col items-start gap-[8px]">
                ...
                >
                  <path
                    fillRule="evenodd"
                    clip-rule="evenodd"
                    d="M9.5 3.88477C8.60254 3.88477 7.875 4.6123 7.875 5.50977V7.13477H6.25C4.45507 7.13477 3 8.58984 3 10.3848V26.6348C3 28.4297 4.45507 29.8848 6.25 29.8848H25.75C27.5449 29.8848 29 28.4297 29 26.6348V10.3848C29 8.58984 27.5449 7.13477 25.75 7.13477H24.125V5.50977C24.125 4.6123 23.3975 3.88477 22.5 3.88477C21.6025 3.88477 20.875 4.6123 20.875 5.50977V7.13477H11.125V5.50977C11.125 4.6123 10.3975 3.88477 9.5 3.88477ZM9.5 12.0098C8.60254 12.0098 7.875 12.7373 7.875 13.6348C7.875 14.5322 8.60254 15.2598 9.5 15.2598H22.5C23.3975 15.2598 24.125 14.5322 24.125 13.6348C24.125 12.7373 23.3975 12.0098 22.5 12.0098H9.5Z"
                    fill="#d4d4d4"
                  />
                </svg>
                <div className="skeleton skeleton-text skeleton-text-animated page_heading !w-[150px]"></div>
