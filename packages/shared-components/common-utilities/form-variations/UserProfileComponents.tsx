          ...
          <div className="form-inner-wrap form-card flex flex-col flex-1 gap-[24px]">
                ...
                <div className="form-col flex flex-col flex-1 gap-1">
                  ...
                  <div className='flex flex-col md:flex-row gap-[8px]'>
                    <input
                      ...
                      autoComplete="off"
                    />
                    <button className='btn btn-primary max-w-[136px]'>Submit number</button>
                  </div>
              ...
              <h5 className='text-heading5'>Address details</h5>
                <div className="form-row form_radio flex flex-col gap-[4px]">
                  ...
                  <div className="form-radio-group flex flex-row gap-[6px] md:gap-[8px]">
                    <div className="col flex relative">
                      <input type="radio" name="cor" className="form-check-input rounded-[4px] outline-none absolute opacity-0 pointer-events-none" id="UK"
                      />
                      <label
                        htmlFor="UK"
                    ...
                    <div className="col flex relative">
                      <input type="radio" name="cor" className="form-check-input rounded-[4px] outline-none absolute opacity-0 pointer-events-none" id="RoW"
                      />
                      <label
                        htmlFor="RoW"
                        className="check-label small font-semibold text-primary-400 bg-white border border-primary-400 rounded-[18px] px-[16px] py-[7px]"
                ...
                <div className='form-row'>
                  <div className="form-col flex flex-col flex-1 gap-1">
                    ...
                    <div className='flex flex-col md:flex-row gap-[8px]'>
                      <input
                        type="textbox" {...register('postcodeFinder', {
                          required: true,
                          minLength: 12,
                          maxLength: 15,
                          pattern: /^\+?[0-9]+$/,
                        ...
                        autoComplete="off"
                        />
                        <button className='btn btn-primary max-w-[120px]'>Find address</button>
                    </div>
                  </div>       
                </div>
                <div className='form-row'>
            ...
            <div className='persoanl-info-details flex flex-col gap-[24px] border-t border-t-grey-200 pt-[24px]'>
              ...
              <div className="form-row form_radio flex flex-col gap-[4px]">
                ...
                <span className='xs-small font-semibold text-grey300'>CHOOSE ONE</span>
                <div className="form-radio-group flex flex-row gap-[6px] md:gap-[8px]">
                  <div className="col flex relative">
                    <input type="radio" name="yoe" defaultChecked className="form-check-input rounded-[4px] outline-none absolute opacity-0 pointer-events-none" id="2025"
                    />
                    <label htmlFor="2025" className="check-label small font-semibold text-primary-400 bg-white border border-primary-400 rounded-[18px] px-[16px] py-[7px]"
                    >
                      2025
                    </label>
                  </div>
              ...
              <div className="form-row form_radio flex flex-col gap-[4px]">
                ...
                <div className="form-radio-group flex flex-row gap-[6px] md:gap-[8px] max-md:overflow-x-auto max-md:w-[calc(100%_+16px)] max-md:pr-[16px] max-md:scrollbar-hidden">
                  <div className="col flex relative">
                    <input type="radio" name="studyLevel" defaultChecked className="form-check-input rounded-[4px] outline-none absolute opacity-0 pointer-events-none" id="UG"
                    />
                    <label htmlFor="UG" className="check-label small font-semibold text-primary-400 bg-white border border-primary-400 rounded-[18px] px-[16px] py-[7px]"
                    >
                      Undergradute
                    </label>
                  </div>
                  <div className="col flex relative">
                    <input type="radio" name="studyLevel" className="form-check-input rounded-[4px] outline-none absolute opacity-0 pointer-events-none" id="Postgraduate"
                    />
                    <label
                  ...
                  <div className="col flex relative">
                    <input type="radio" name="studyLevel" className="form-check-input rounded-[4px] outline-none absolute opacity-0 pointer-events-none" id="Foundation"
                    />
                    <label
                      htmlFor="Foundation"
                      className="check-label small font-semibold text-primary-400 bg-white border border-primary-400 rounded-[18px] px-[16px] py-[7px]"
            ...
            <div className='predicted_grades flex flex-col gap-[4px]'>
                <div className='small font-semibold text-grey300'>Predicted grades</div>
                <p className='small text-grey300'>You have not yet added any qualifications</p>
            ...
            <div className='sticky-btn-card w-full fixed bottom-0 left-0 z-[5] flex justify-end bg-grey-600 p-[16px_24px]'>
              <button className='btn flex justify-center items-center gap-[4px] min-w-[107px] max-w-[120px] hover:underline'>
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M1.8173 1.8173C2.24037 1.39423 2.9263 1.39423 3.34937 1.8173L8 6.46794L12.6506 1.8173C13.0737 1.39423 13.7596 1.39423 14.1827 1.8173C14.6058 2.24037 14.6058 2.9263 14.1827 3.34937L9.53206 8L14.1827 12.6506C14.6058 13.0737 14.6058 13.7596 14.1827 14.1827C13.7596 14.6058 13.0737 14.6058 12.6506 14.1827L8 9.53206L3.34937 14.1827C2.9263 14.6058 2.24037 14.6058 1.8173 14.1827C1.39423 13.7596 1.39423 13.0737 1.8173 12.6506L6.46794 8L1.8173 3.34937C1.39423 2.9263 1.39423 2.24037 1.8173 1.8173Z" fill="white"/>
                </svg>
 Reset</button>
              <button className='btn btn-primary min-w-[150px] max-w-[180px]'>Save changes</button>
            </div>
          </form>
        </div>  
      </div>
