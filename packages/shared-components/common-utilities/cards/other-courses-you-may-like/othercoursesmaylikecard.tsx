    ...
    return (
        <Link href={val?.courseUrl} className='card flex flex-col bg-white border border-grey-200 lg:hover:border-primary-400 rounded-[8px] shadow-custom-2 overflow-hidden'>
            <div className='card-header relative min-h-[190px] bg-grey-200'>
                {val?.wuCollegeImage &&
                    <Image src={val?.wuCollegeImage} width="392" height="221" className='block w-full h-auto min-h-[185px]' alt='Article_image' />
                }
                <div className='absolute z-[1] top-[16px] left-[16px] rounded-[8px] overflow-hidden'>
                    {val?.wuCollegeLogo &&
                        <Image src={val?.wuCollegeLogo} width="64" height="64" alt="University logo" />
                    }
                </div>
            ...
            <div className='card-body flex flex-col justify-between gap-[52px] p-[16px] min-h-[192px]'>
                <div className='flex flex-col gap-[8px] w-full'>
                    <div className='card-title font-farro para-lg font-bold text-grey300 line-clamp-2'>{val?.courseTitle}</div>
