  ...
  return (
    ...
    >
      <div className="card-header relative min-h-min bg-grey-200">
        ...
        ) : userFavourites || activityProspectuses ? (
          <>
      ...
      {seasonWusca || userFavourites ? (
          ...
          {openDays ? (
            <>
              <div className="flex">
                ...
                <div className="card-body min-h-[215px] h-full flex flex-1 flex-col justify-between gap-[16px] p-[16px]">
            ...
            <>
              <div
                className={`card-body h-full flex flex-col justify-between gap-[16px] p-[16px] ${activityProspectuses ? "min-h-[112px]" : uniFavourites ? "min-h-[376px]" : "min-h-[215px]"}`}
              >
                <div className="flex flex-col gap-[8px] w-full">
                  {userFavourites ? (
                    ""
                  ) : (
                    <div className="clearing-tag xs-small font-bold text-positive-dark bg-green-200 uppercase w-fit rounded-[4px] p-[0_8px]">
                      Clearing
                    </div>
                  )}
                  <div className="card-title font-farro para-lg font-bold text-grey300 line-clamp-2">
                  ...
                  >
                    {userFavourites ? (
                      uniFavourites ? (
                        ...
                        <>
                          {prosClicked ? (
                            <div className="flex items-center justify-center gap-[4px] p-[8px_16px] text-positive-default small font-semibold">
                              <Tick hover="stroke-positive-default" />
                              Prospectus Ordered
                            </div>
                          ) : (
        ...
        <div className="card-body min-h-[215px] h-full flex flex-col justify-between gap-[16px] p-[16px]">
          <div className="flex flex-col gap-[8px] w-full">
            <div className="card-title font-farro para-lg font-bold text-grey300 line-clamp-2">
              Modern History with a Placement Year BA (Hons)
            </div>
            <div className="para small font-semibold ">
