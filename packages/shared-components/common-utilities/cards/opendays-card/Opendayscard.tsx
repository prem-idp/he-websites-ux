...
const Opendayscard = ({
  ...
  return (
    <>
      <div
        className={`card h-full flex flex-col bg-white border border-grey-200 rounded-[8px] shadow-custom-2 overflow-hidden`}
      >
        {providerOpenDays || onlineOpendays ? (
          ...
          <div className="card-header relative min-h-min bg-grey-200">
            ...
            <div className="absolute z-[1] top-[16px] left-[16px] rounded-[8px] overflow-hidden">
              <Image
                src="/static/assets/images/uni_logo_tile1.jpg"
                width="64"
                height="64"
                alt="University logo"
              />
            </div>
            <div className="absolute left-[16px] bottom-[16px] text-[12px] leading-[20px] font-bold text-grey-500 bg-grey-100 border-b border-dotted p-[0_8px] rounded-[4px] z-0 uppercase">
              {studyType}
            </div>
        ...
        <div className="card-body flex flex-col justify-between h-full">
          <div className="flex h-full">
            {onlineOpendays ? (
              ...
              <div
                className={`opd-calendar ${featureOpd ? "bg-primary-100" : "bg-grey-100"} border-r border-grey-200`}
              >
            ...
            >
              <div className="flex flex-col gap-[8px] w-full">
                ...
                {providerOpenDays || onlineOpendays ? (
                  <div className="w-fit text-[12px] leading-[20px] font-bold text-grey-500 bg-grey-100 p-[0_8px_1px] rounded-[4px] z-0 uppercase">
                    <span className="border-b border-dotted border-grey-500">
                      {studyType}
                    </span>
                  </div>
                ) : (
                ...
                {onlineOpendays ? (
                  ...
                  <>
                    ...
                    <div className="flex flex-col gap-[8px]">
                      <div className="card-subtitle small font-semibold line-clamp-1">
                        {opendaysType}
                      </div>
                      <div className="">
                        {activityOpendays ? (
                          <div className="xs-small font-semibold text-grey-900 uppercase">
                            booked ON 29 JUL 2024
                          </div>
                        ) : (
                          location && (
