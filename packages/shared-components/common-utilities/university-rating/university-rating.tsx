  ...
  return (
    <div className="card flex flex-col gap-[16px] w-full border border-grey-200 rounded-[8px] bg-white p-[16px] md:p-[24px]">
      <div className="card-header flex flex-col gap-[8px]">
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-[8px]">
          <div className="h5 text-grey300">How animation students rated:</div>
          <div className="relative group flex items-center gap-[8px] para font-semibold text-primary-400 hover:text-primary-500 hover:underline cursor-pointer pb-[10px] mb-[-10px]">
            University Rating
            <svg
              width="12"
              height="8"
            ...
            <div className="hidden z-[1] bg-white shadow-custom-3 rounded-[4px] absolute left:0 md:right-0 top-[32px] w-[326px] md:w-[342px] group-hover:block">
              <div className="w-fit px-[8px] py-[4px] x-small text-grey-500 bg-grey-100 font-bold rounded-[4px] m-[16px]">
                RATING TYPE
              </div>
