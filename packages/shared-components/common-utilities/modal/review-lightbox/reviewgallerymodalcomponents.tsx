...
import Reviewdetailcommentscomponents from '@packages/shared-components/common-utilities/modal/review-lightbox/reviewdetail-comments/reviewdetailcommentscomponents';

const Reviewgallerymodalcomponents = ({ setOpengallery }: any) => {
