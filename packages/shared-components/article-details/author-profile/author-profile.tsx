...
import { ImageUpload } from "./../../../lib/types/interfaces";
      ...
      <div className="border-t-[1px] lg:border-y-[1px] border-grey-200 py-[16px] min-w-[289px] max-w-[100%]">
        <div className="flex gap-[16px]">
          ...
          <div className="flex flex-col">
            <span className="text-blue-400 small font-medium">{`${data?.author?.firstName ?? ""} ${data?.author?.middleName ?? ""} ${data?.author?.lastName ?? ""}`}</span>
