                ...
                />
                          ...
                          <div className="flex flex-col gap-[32px] items-center">
                              ...
                              <button className="md:min-w-[111.5px] min-w-[69px] flex flex-col gap-[9px] items-center text-blue-400 hover:text-grey300 hover:underline">
                                  <Image width="40" height="40" src="/static/assets/icons/facebook-blue.svg" alt="Facebook" />
                                  <span className="small font-inter">Facebook</span>
                              </button>                    
                              <button className="md:min-w-[111.5px] min-w-[69px] flex flex-col gap-[9px] items-center text-blue-400 hover:text-grey300 hover:underline">
                                  <Image width="40" height="40" src="/static/assets/icons/twitter-blue.svg" alt="twitter" />
                                  <span className="small font-inter">Twitter</span>
                              </button>                    
                              <button className="md:min-w-[111.5px] min-w-[69px] flex flex-col gap-[9px] items-center text-blue-400 hover:text-grey300 hover:underline">
                                  <Image width="40" height="40" src="/static/assets/icons/pinterest.svg" alt="pinterest" />
                                  <span className="small font-inter">Pinterest</span>
                              </button>                    
                              <button className="md:min-w-[111.5px] min-w-[69px] flex flex-col gap-[9px] items-center text-blue-400 hover:text-grey300 hover:underline">
                                  <Image width="40" height="40" src="/static/assets/icons/copy-link.svg" alt="Copy link" />
