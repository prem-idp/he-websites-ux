...
describe('Shortlisted Component', () => {
  it('renders the list items correctly when data is provided', () => {
    ...
    expect(screen.getByText('Item 1').closest('a')).toHaveAttribute('href', '/item1');
    expect(screen.getByText('Item 2').closest('a')).toHaveAttribute('href', '/item2');
    expect(screen.getByText('Item 3').closest('a')).toHaveAttribute('href', '/item3');
  });
  ...
  it('renders the "Compare" button with correct href', () => {
    ...
    expect(compareButton.closest('a')).toHaveAttribute('href', '/degrees/comparison');
  });
